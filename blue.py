...
listConsigli = ["Apri un Blog!", "Convinci qualcuno a finanziarti!", "Parla solo con chi ha almeno un dottorato!",
                ...
                "La tua parola deve sempre prevalere in una discussione!",
                ...
                "Piega perfettamente le camicie e mettile sempre nel cellophane!",
                "Non si può pagare con carta? No grazie!",
...
listaforismi = ["Ai nostri tempi quando che si stava meglio", "Ah i giovani d\'oggi",
                ...
                "Sti giovani, tutti dei maleducati!",
                "Ai miei tempi a scuola andavo a piedi, con un metro e mezzo di neve, e camminavo per venti chilometri",
...
listafotoanziani = ["http://www.grottaglieinrete.it/it/wp-content/uploads/2014/04/sociale-vecchi-anziani.jpeg",
                    ...
                    "http://italia-notizie.it/wp-content/uploads/2015/06/spa02.jpg",
                    "http://la-zanzara.radio24.ilsole24ore.com/wp-content/uploads/sites/101/2016/11/napolitano.jpg",
...
listCreateFraseUno = ["Neil DeGrass Tyson diceva che", "I vulcaniani pensano che", "State sottovalutando il fatto che",
                      ...
                      "Steve Jobs diceva spesso che", "Ma sai che su Focus tempo fa c\'era un articolo che diceva", "Ripeto, per me", "pensa,"]
